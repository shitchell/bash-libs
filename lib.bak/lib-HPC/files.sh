...
# @description Given a file, determine if it's a java class
# @return 0 file is a java class
# @return 1 file is not a java class
# @return 2 no file was specified
# @return 3 file does not exist or is not readable
# @return 4 file is a directory
# @return 5 file is a symlink
# @return 6 no extension
# @return 7 invalid extension
